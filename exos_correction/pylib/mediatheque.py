...
class TvShow:
    ...
    @classmethod
    def with_episodes(cls, name:str, episodes:list): # TvShow.with_episodes('myshow', [])
        # episodes liste de tuples (title, season_number, number, duration, year)

        my_show = cls(name)
        for episode in episodes:
            my_show.add_episode(*episode)
